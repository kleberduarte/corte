  ...
  return (
    <div className="screen" style={{ padding: '0 0 12px' }}>
      <div style={{ flexShrink: 0, padding: '8px 20px 16px' }}>
        <div style={{ fontFamily: 'var(--font-serif)', fontSize: 'calc(28px * var(--font-scale))', fontWeight: 700, color: 'var(--accent)', lineHeight: 1.15 }}>
          Como deseja retirar?
        </div>
        <div style={{ fontSize: 'calc(13px * var(--font-scale))', color: 'var(--t3)', marginTop: 6, lineHeight: 1.5 }}>
          ...
          {CARDS.map((card, i) => (
            ...
            >
              ...
              >
                ...
                >
                  <span style={{ fontSize: 'calc(12.5px * var(--font-scale))', fontWeight: 600, color: 'rgba(255,255,255,.55)' }}>
                    {card.hint}
                  </span>
                  <span
                    style={{
