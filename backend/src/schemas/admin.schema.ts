...
export const createStoreSchema = z.object({
  name:    z.string().min(2),
  chain:   z.enum(['PAO_DE_ACUCAR', 'EXTRA', 'VIOLETA', 'CARREFOUR', 'ATACADAO', 'ASSAI', 'SUPERMERCADOS_MATEUS', 'BIG', 'PREZUNIC', 'MUNDIAL', 'SONDA', 'CONDOR', 'SUPER_MUFFATO', 'ZAFFARI', 'BOURBON', 'COOP', 'HIROTA', 'REDE_SMART', 'ST_MARCHE', 'CORTE_SUPERMERCADO', 'OUTROS']),
